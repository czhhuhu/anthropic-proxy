...
public class ModelMappingService {
    ...
    public ModelMappingService() {
        ...
        modelMapping.put("claude-3-sonnet-20240229", "gpt-4");
        modelMapping.put("claude-3-sonnet", "gpt-4");
        ...
        // Claude 2 series
        modelMapping.put("claude-2.1", "gpt-4");
        modelMapping.put("claude-2.0", "gpt-4");

        // Claude Instant
        modelMapping.put("claude-instant-1.2", "gpt-3.5-turbo");

        // Default mapping
        modelMapping.put("default", "gpt-3.5-turbo");
    }
